class DropBoxController {
  ...
  connectFirebase() {
    var firebaseConfig = {
      apiKey: "AIzaSyD01bTSp1NIycOQraoxfPVktWTuwQanjtI",
      authDomain: "dropbox-clone-1aaaa.firebaseapp.com",
      databaseURL: "https://dropbox-clone-1aaaa.firebaseio.com",
      projectId: "dropbox-clone-1aaaa",
      storageBucket: "dropbox-clone-1aaaa.appspot.com",
      messagingSenderId: "867744837848",
      appId: "1:867744837848:web:04d5f8d75d9b7b693127ad",
      measurementId: "G-M1RHEX5LCS"
    };
    // Initialize Firebase
  ...
  initEvents() {
    this.btnNewFolder.addEventListener("click", e => {
      ...
      if (name) {
        this.getFirebaseRef()
          .push()
          .set({ name, type: "folder", path: this.currentFolder.join("/") });
      }
    });
