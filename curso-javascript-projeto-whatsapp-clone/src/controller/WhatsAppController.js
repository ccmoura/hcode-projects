...
export class WhatsAppController {
  ...
  checkNotifications() {
    if (typeof Notification === "function") {
      if (Notification.permission !== "granted") {
        this.el.alertNotificationPermition.show();
      } else {
        this.el.alertNotificationPermition.hide();
      }
      this.el.alertNotificationPermition.on("click", e => {
      ...
      .then(response => {
        ...
        this._user.on("datachange", data => {
          ...
          document.querySelector(
            "title"
          ).innerHTML = `${data.name} | WhatsApp Clone`;
      ...
      docs.forEach(doc => {
        ...
        div.innerHTML = `
                        ...
                        <div class="_3j7s9">
                            <div class="_2FBdJ">
                                <div class="_25Ooe">
                                    <span dir="auto" title="Nome do Contato" class="_1wjpf">${
                                      contact.name
                                    }</span>
                                </div>
                                <div class="_3Bxar">
  ...
  initEvents() {
    ...
    this.el.inputProfilePhoto.on("change", e => {
      if (this.el.inputProfilePhoto.files > 0) {
